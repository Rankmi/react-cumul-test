    ...
    <Row>
        ...
        <Col xl="3" lg="12">
          ...
          <Row style={{marginTop: '20px'}}>
            ...
            <Col lg="12" md="6">
              {ssoToken && showedDashboardId ? <Dashboard ssoToken={ssoToken} ssoToken={ssoToken} dashboardId={showedDashboardId}/> : null }
            </Col>
          ...
          <Col xl="3" lg="12">
            ...
            <Row style={{marginTop: '20px'}}>
              ...
              <Col lg="12" md="6">
                <Dashboard ssoToken={ssoToken} ssoToken={ssoToken} dashboardId={"035c0304-0bfe-4b7c-8c10-a4acb8eb9d76"}/>
              </Col>
